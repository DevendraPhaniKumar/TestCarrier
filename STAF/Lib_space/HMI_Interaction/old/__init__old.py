...
class HMI_Interaction:
    ...
    def __Reset(self):
        if self.Hwtype == "PIC5":            
            ...
            # Click on Alarm power button
            data = self.__moveTo("ALM_PWR_BUTTON")
            time.sleep(0.5)
            pyautogui.click()
            # Click on Reset Alarm Button
            data = self.__moveTo("ALMRESET_BUTTON")
            time.sleep(0.5)
            pyautogui.click()
            # Click on Reset Alarm ON Button
            data = self.__moveTo("ALMRESET_ON_BUTTON")
            time.sleep(0.5)
            pyautogui.click()
