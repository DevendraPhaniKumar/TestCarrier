...
class ApplicationBootuptime(unittest.TestCase):
    ...
    def test_appbootuptime(self):
        ...
        print("Captured app time is : "+stoptime)
...
if __name__ == '__main__':
    ...
    c=ApplicationBootuptime()
    c.test_appbootuptime()
