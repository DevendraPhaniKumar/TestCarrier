...
class ScreenTransTime9(unittest.TestCase):

    def test_K09_AlarmToResetAlarm(self):
        print('*'*25)
        print('K9_Alarm To Reset Alarm Screen Transistion \n')
        STM.click(self,763,28)  # Click Operation on PIC6
        print("Clicked Alarm Button \n")
        time.sleep(Screendelay)
        STM.click(self,121,130)  # Click Operation on PIC6
...
#     suite = unittest.TestLoader().loadTestsFromTestCase(ScreenTransTime9)
