...
class ScreenTransTime10(unittest.TestCase):
    ...
    def test_K10_HomeToCircuitA(self):
        ...
        STM.click(self,336,260)  # Click Operation on PIC6
...
#     suite = unittest.TestLoader().loadTestsFromTestCase(ScreenTransTime10)
