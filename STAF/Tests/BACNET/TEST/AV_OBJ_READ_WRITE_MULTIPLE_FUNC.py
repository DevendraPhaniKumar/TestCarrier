...
class BACnet_AnalogValue_Object_Multiple_Test(unittest.TestCase):
    ...
    def test_BACnet_AnalogValue_Obj_ReadMultiple_func(self):
    ...
    def test_BACnet_AnalogValue_Obj_WriteMultiple_func(self):
        
        failStr = ''
        
        try:
            print('--------------------START-------------------------------')
            print('<----Write Analog Value of Instance :'+str(analog_value_obj_multiple_write_list)+'--->')
            for item in analog_value_obj_multiple_write_list:
                for k,v in item.items():      
